            ...
            <div className="notifications" id="notifications">
                ...
                (
                    <div className="notification notification-warning" id="release-notification"><b>
                        Dear Users, starting from 1<sup>st</sup> May 2021, Todo Application will Verify All Accounts by sending verification through email. Note that, there is changes for Format Date in Todo Application v0.4.6, as a result users will receive `NaN-NaN-NaN` Date Format in the first 12 ~ 15 hours after this release.
