                    ...
                    <form className="contact__form" name="contact__form" onSubmit={Submit}>
                        ...
                        <div className="contact__formControl">
                            <div className="contact__infoField">
                                ...
                                <input title="Email" id="userEmail" type="email" className="contact__inputField" onChange={(event) => setEmail(event.target.value)} value={email} autoFocus required autoComplete="username"/>
                                <span className="contact__onFocus"></span>
                            </div>
                        </div>
