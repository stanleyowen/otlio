                        ...
                        new RevokedToken ({ userId: _id, token: encrypt(req.cookies['jwt-token'], 1) }).save(err => {
                            ...
                            user.save(err => {
                                ...
                                const mailOptions = {
                                    ...
                                    html: `Hi ${email},<br><br>We wanted to inform that your Otlio password has changed.<br><br> If you did not perform this action, you can recover access by entering ${email} into the form at ${CLIENT_URL}/reset-password<br><br>If you run into problems, please email us at stanleyowen06@gmail.com<br><br>Please do not reply to this email with your password. We will never ask for your password, and we strongly discourage you from sharing it with anyone.`
                                }
